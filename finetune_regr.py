...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_name", default='esol', choices=['esol', 'freesolv', 'lipophilicity', 'qm7', 'qm8', 'qm9', 'qm9_gdb'])
    parser.add_argument("--split_type", default='scaffold', choices=['random', 'scaffold', 'random_scaffold', 'index'])
    """
    esol: random,    freesolv: random,    lipophilicity: random,    qm7: 
    qm8: random,     qm9: random,         qm9_gdb: random
    """
    ...
    parser.add_argument("--init_model", type=str, default='../../../../../GEM_pretrain_models/zinc_[ab]_bs512_lr0.001_dr0.2/epoch0.pdparams')  # GEM_pretrain_models/zinc_lr0001_bs512/epoch45.pdparams
