...
def init_encoder_model(args):
    """
    Build compound_encoder with GeoGNNModel, based on geognn_l8.json
        __init__()
    ...
    Get task names
    """
    print("=========== Initialize GeoGNNModel and DownstreamModel ===========")
...
def main(args):
    ...
    for epoch_id in range(args.max_epoch):
        ...
        # model_dir_datasetname_suffix = args.model_dir + "/" + args.dataset_name + "_" + args.model_dir_suffix
        # paddle.save(compound_encoder.state_dict(),
        #         '%s/epoch%d/compound_encoder.pdparams' % (model_dir_datasetname_suffix, epoch_id))
        # paddle.save(model.state_dict(),
        #             '%s/epoch%d/model.pdparams' % (model_dir_datasetname_suffix, epoch_id))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", choices=['train', 'data'], default='data')

    parser.add_argument("--batch_size", type=int, default=32)  # 32
    parser.add_argument("--num_workers", type=int, default=8)  # 2
    parser.add_argument("--max_epoch", type=int, default=2)  # 100

    parser.add_argument("--data_path", type=str, default='../../../../../RAW_downstream_datasets')
    parser.add_argument("--cached_data_path", type=str, default='../../../../../GEM_cached_data')
    parser.add_argument("--dataset_name", default='bace', choices=['bace', 'bbbp', 'hiv', 'clintox', 'muv', 'sider', 'tox21', 'toxcast', 'pcba'])
    parser.add_argument("--split_type", default='scaffold', choices=['random', 'scaffold', 'random_scaffold', 'index'])
    """
    bace: scaffold,    bbbp: scaffold,    hiv: scaffold
    clintox: random,   muv: random,       sider: random,     tox21: random,      toxcast: random
    """
    ...
    parser.add_argument("--init_model", type=str, default='../../../../../GEM_pretrain_models/zinc_[ab_ba_da]_bs512_lr0.001_dr0.2/epoch0.pdparams')  # GEM_pretrain_models/zinc_lr0001_bs512/epoch45.pdparams
    parser.add_argument("--model_dir", type=str, default='../../../../../GEM_downstream_models')
    ...
    ##############test#########
    testArgs="--task='data' --dataset_name='pcba' --split_type='scaffold' --subgraph_archi='ab_ba_da' "
    args=argparse.ArgumentParser(testArgs.strip().split())
    ##############test#########
    print("==========================  args  =============================")
