...
class DownstreamModel(nn.Layer):
    ...
    def forward(self, atom_bond_graphs, bond_angle_graphs, dihedral_angle_graphs):
        """
        ...
        """
        node_repr, edge_repr, plane_repr, graph_repr = self.compound_encoder(atom_bond_graphs, bond_angle_graphs, dihedral_angle_graphs)
