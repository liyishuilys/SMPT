...
import time
import argparse
from apps.pretrained_compound.ChemRL.GEM.src.utils import *
    ...
    for root, dirs, files in os.walk(args.pickle_path):
        for name in files:
            if name.endswith(".pkl"):
                files_list.append([root, name])  # ../../../../../../GEM_pickle_dataset_new/0_500000/0, 0_0_3199.pkl
    return files_list
...
def main(args):
    ...
    for fid, file in enumerate(files_list):
        root, name = file  # ../../../../../../GEM_pickle_dataset_new/0_500000/0/0_0_3199.pkl
...
if __name__ == '__main__':
    ...
    """
    parser.add_argument("--pickle_path_new", type=str, default='../../../../../../GEM_pickle_dataset_new')
